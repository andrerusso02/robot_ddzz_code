...
class TurtleBot:
    ...
    def move2angle(self, angle, tolerance):
        ...
        while abs(self.get_angle(self.pose, angle)) > tolerance:
            ...
            # print("diff: " + str(angle - self.pose.theta))
            print()
    ...
    def cmd_rotation(self, angle):
        ...
        vel_msg.angular.z = self.angular_vel(angle)
    ...
    def angular_vel(self, goal_angle, constant=2.5):
    ...
    def move2goal(self, goal_pose):
        ...
        while dist >= distance_tolerance:
            ...
            if abs(vel_msg.linear.x) > self.max_vel:
                vel_msg.linear.x = self.max_vel
            vel_msg.linear.y = 0
            vel_msg.linear.z = 0
            ...
            if abs(vel_msg.angular.z) > self.max_ang_vel:
                vel_msg.angular.z = self.max_ang_vel
